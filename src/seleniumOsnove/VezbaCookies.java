...
public class VezbaCookies
{
  ...
  public static void main(String[] args) throws InterruptedException
  {
    ...
    WebElement addButton = driver.findElement(By.xpath("//*[@id=\"add-to-cart-button\"]"));
    addButton.click();
    Thread.sleep(3000);
    
    WebElement cartButton = driver.findElement(By.xpath("//*[@id=\"nav-cart-count\"]"));
    cartButton.click();
    Thread.sleep(3000);
    ...
    if(cart.getText() == "//*[@id=\"nav-cart-count\"]")
    {
